...
class QuestionBank {
  ...
  void nextQuestion() {
    if (_questionnumber < _t.length - 1) {
      _questionnumber++;
    } else {
      _questionnumber = (_questionnumber + 1) % _t.length;
    }
  }

  String getQuestionText() {
    return _t[_questionnumber].questionText;
  }

  bool getQuestionAnswer() {
    return _t[_questionnumber].questionAnswer;
  }
}
